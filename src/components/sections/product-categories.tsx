  ...
  const categories = [
    {
      id: 1,
      name: 'Xaropes Saborizados',
      image: 'https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/a03201d5-2727-41ab-9ec0-b82cea30b5d3/generated_images/professional-product-photography-of-flav-17c371e8-20250829192105.jpg',
      href: '/collections/xaropes-saborizados'
    },
    {
      name: 'Sabores Sem Açúcar',
